        ...
        {assignTask ? (
          <div className="assignedtaskpreview">
            <p className="asstskdecp">
              ...
              consectetur adipisicing elit. Vero eaque velit qui. Rerum dolores
              earum commodi expedita officia necessitatibus excepturi magni
              aliquid eos iure sed quaerat, a dolorum placeat est?
            </p>
